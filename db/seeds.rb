class Seed
  ...
  def generate_breeds
    ...
    Breed.create!(
      ...
      image: "http://www.gatospedia.com/wp-content/uploads/2013/06/siames.jpg",
    ...
    Breed.create!(
      ...
      image: "https://d2pu2bk1b66iw6.cloudfront.net/photos/2015/07/15/6-110041-chinchilla-persian-9-510x600-1436975539.jpg",
    ...
    Breed.create!(
      ...
      image: "http://www.catster.com/wp-content/uploads/2017/01/maine-coon-02-74571586-600x693.jpg",
    ...
    Breed.create!(
      ...
      image: "http://domashnie-koshki.info/cat_breeds/american_shorthair/photo/american_shorthair_03_large.jpg",
    ...
    Breed.create!(
      ...
      image: "http://www.royal-canin.ru/upload/iblock/0c7/7690.jpg",
    ...
    Breed.create!(
      ...
      image: "http://images.mentalfloss.com/sites/default/files/styles/insert_main_wide_image/public/burmese1.jpg",
    ...
    Breed.create!(
      ...
      image: "http://ecodecopethospital.com/wp-content/uploads/2015/02/Bengal-sitting-cat-450x481.jpg",
    ...
    Breed.create!(
      ...
      image: "http://elelur.com/data_images/cat-breeds/sphynx-cat/sphynx-cat-05.jpg",
    ...
    Breed.create!(
      ...
      image: "https://s-media-cache-ak0.pinimg.com/736x/1b/5c/04/1b5c044b0d18c60e1ac5a04938effc5e--exotic-shorthair-cat-griffins.jpg",
